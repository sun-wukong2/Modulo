# This code creates a graph of graphs with C and N values on axis to analyze what patterns patterns occur in.
...
final_path = os.path.join(desktop_path, f"horizontal_assembly_n{n_start}_to_n{n_end}_a={a}_b={b}.png")
